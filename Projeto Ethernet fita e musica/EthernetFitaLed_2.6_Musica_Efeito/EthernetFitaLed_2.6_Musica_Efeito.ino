...
int Qtdleds = 0;
int i = 0;
int numMin = 20; //Numero minimo do sinal para ligar todos os leds
int maior = numMin;
    ...
    while (client.connected())
    {
      if (client.available())
      {
        ...
        if (c == '\n')
        {
          ...
          client.println("<body bgcolor='#505050'>");
          ...
          if (luz == 0) {
            client.println("Luz desligada");
          }
          if (luz == 1) {
            client.println("Luz Ligada");
          }

          if (Musica == 0) {
            client.println("<br/>Musica Desligada");
          }
          if (Musica == 0) {
            client.println("<br/>Musica Ligada");
          }
          if (efeitosMusica == 0) {
            client.println("<br/>Efeito Musica 1");
          }
          if (efeitosMusica == 1) {
            client.println("<br/>Efeito Musica 2");
          }
